...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети ClientDesk.."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC ClientDesk может работать некорректно на удаленном узле. Чтобы избежать UAC, нажмите кнопку ниже, чтобы установить ClientDesk в системе"),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удаленно управлять своим рабочим столом, вы должны предоставить ClientDesk права \"доступа\""),
        ("config_screen", "Для удаленного доступа к рабочему столу вы должны предоставить ClientDesk права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удаленное устройство могло управлять вашим Android-устройством с помощью мыши или касания, вам необходимо разрешить ClientDesk использовать службу «Специальные возможности»."),
        ("android_input_permission_tip2", "Перейдите на следующую страницу системных настроек, найдите и войдите в [Установленные службы], включите службу [ClientDesk Input]."),
