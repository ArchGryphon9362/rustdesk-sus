...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem ClientDesk-Netzwerk..."),
        ...
        ("install_tip", "Aufgrund der UAC kann ClientDesk in manchen Fällen nicht ordnungsgemäß auf der Gegenseite funktionieren. Um UAC zu vermeiden, klicken Sie bitte auf die Schaltfläche unten, um ClientDesk auf dem System zu installieren"),
        ...
        ("config_acc", "Um Ihren Desktop aus der Ferne zu steuern, müssen Sie ClientDesk \"Zugangs\" Rechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren Desktop zugreifen zu können, müssen Sie ClientDesk \"Bildschirm-Aufnahme\" Berechtigungen erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein Remote-Gerät Ihr Android-Gerät per Maus oder Berührung steuern kann, müssen Sie ClientDesk erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen und geben Sie [Installierte Dienste] ein, schalten Sie den Dienst [ClientDesk Input] ein."),
